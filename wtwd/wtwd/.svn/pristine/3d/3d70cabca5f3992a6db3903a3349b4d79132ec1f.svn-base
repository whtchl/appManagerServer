...
<HTML>
	...
	<BODY>
	<s:form action="saveResource" method="post">
		<table cellspacing="1" cellpadding="3" width="100%" align="center"
			border="0">
			<tr>
				<th colspan="3" class="td_title" style="TEXT-ALIGN: center">
					<span class="td_title" style="TEXT-ALIGN: center">创建系统菜单</span>
				</th>
			</tr>			
			<tr class='tdbg2'>
			...
			<tr class="td1">
				...
				<td width='84%' class="td1">
					<s:select list="#{0:'--公用--',1:'test1.com.cn',2:'test2.com'}" name="resourceInfo.domain"></s:select>
				</td>
			</tr>			
