...
<BODY>
<s:fielderror />
 <form name="theform" action="/paddVerInfo" method="post"   onSubmit="return check();">
    ...
    <tbody>
      ...
      <TR>
        ...
        <TD width="640"class=td2>
          <div align="left"><INPUT size=25 name="ver"/><br><INPUT size=25 name="ptype" type="hidden" value="<s:property value="ptype"/>"/><span class="STYLE1">*</span> 软件版本命名规则，由ABC三组数字组成,字母中间由“.”所间隔开，例如：1.0.0；A段位为大本号；B段位为小版本号，有新增功能模块时进行修改与调整；C段位为BUG修改标识位。
              </div></TD></TR>
