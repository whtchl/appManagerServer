		...
		<table cellspacing="1" cellpadding="3" width="100%" align="center"
			...
			<tr>
				<th colspan="3" class="td_title" style="TEXT-ALIGN: center">
					<span class="td_title" style="TEXT-ALIGN: center">修改系统用户</span>
				</th>
			</tr>
			<tr class="tdbg">
			...
			<tr class='tdbg2'>
				...
				<td width='84%' class="td1">
					<s:select list="#{1:'test1.com.cn',2:'test2.cn',3:'test3.com'}" name="userInfo.validDomain"></s:select>
				</td>
			</tr>
			<tr class='tdbg2'>
				<td width='16%' align='left' class="td1">
			...
			<tr class="tdbg">
				...
				<td class="td2">
					<span class="td1"> 
						<s:textfield name="userInfo.incomeRate" size="8" maxlength="6"></s:textfield>%
					</span>
				</td>
			</tr>
			<tr class="tdbg">
				...
				<td class="td2">
					<span class="td1"> 
						<s:textfield name="userInfo.phoneSaleRate" size="8" maxlength="6"></s:textfield>%
					</span>
				</td>
			</tr>
