...
<HTML>
	...
	<BODY>
		<s:form action="saveCompany" method="post">
			<table cellspacing="1" cellpadding="3" width="100%" align="center"
				...
				<tbody>
					...
					<tr class="title">
						...
						<td class="td2">
							<span class="td1"> 
								<s:select list="userList" listKey="intId" listValue="name" headerKey="0" headerValue="请选择商务负责人" name="companyInfo.salesId"></s:select>
							</span>
						</td>
					</tr>
					<tr class="title">
