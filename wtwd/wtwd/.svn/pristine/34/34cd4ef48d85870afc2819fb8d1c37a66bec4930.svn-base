...
<table cellspacing="1" cellpadding="3" width="100%" align=left border="0">
    <tbody>
      ...
      <tr><td valign="top">[<a href="/customerService/addVerInfo.jsp">新增版本</a>]<br></td>
        <td colspan="4" valign="top">&nbsp;  </td>
      </tr><tr>
        <td height="45" align="center" class="td2"><strong>序号</strong></td>
        <td align="center" class="td2"><strong>版本号</strong> </td>
        <td align="center" class="td2"><strong>客户所见说明</strong></td>
        <td align="center" class="td2"><strong>功能说明</strong></td>
        <td align="center" class="td2"><strong>时间</strong></td>
    ...
    <tbody>
	 ...
	 <s:else>
      ...
      <tr>
        ...
        <td align="center" class='<s:property value="%{#cs}"/>'><s:property value="explain"/>				</td>
        <td align="center" class='<s:property value="%{#cs}"/>'>
          <s:property value="creatTime"/>&nbsp;                					</td>
        <td align="center" class='<s:property value="%{#cs}"/>'><a href="getVerInfo?vid=<s:property value="id"/>">修改</a></td>
      </tr>
      </s:iterator>
      <tr>
