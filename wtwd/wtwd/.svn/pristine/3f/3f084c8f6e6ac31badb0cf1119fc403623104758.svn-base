...
<table cellspacing="1" cellpadding="3" width="100%" align=left border="0">
    <tbody>
      <tr>
        <th colspan="7" class="td_title" style="TEXT-ALIGN: center">评论管理<span class="STYLE1"></span> </th>
      </tr>
      ...
      <tr><td valign="top"><br></td>
        ...
        <td width="19%" align="center" class="td2"><strong>用户名</strong></td>
        <td width="35%" align="center" class="td2"><strong>评论</strong></td>
    ...
    <tbody>
	 <s:iterator value="funCommentslist" status="listid" var="fcl" >
	 ...
	 <s:else>
      ...
      <tr>
        ...
        <td align="center" class='<s:property value="%{#cs}"/>'><s:property value="#fcl.context"/>			</td>
        <td align="center" class='<s:property value="%{#cs}"/>'>
          <s:property value="creattime"/>&nbsp;                					</td>
        <td align="center" class='<s:property value="%{#cs}"/>'><a href="funcommentsdel?comid=<s:property value="#fcl.id"/>&cid=<s:property value="cid"/>">删除</a></td>
      </tr>
      </s:iterator>
      <tr>
