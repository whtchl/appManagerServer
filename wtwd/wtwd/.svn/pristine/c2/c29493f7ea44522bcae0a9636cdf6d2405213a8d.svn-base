...
-->
	...
	<BODY>
		<s:form action="pversionManage">
			<table cellspacing="1" cellpadding="3" width="100%" align=left
				border="0">

				<tbody>
					<tr>
						<th colspan="6" class="td_title" style="TEXT-ALIGN: center">应用软件版本管理 </th>
					</tr>
					<tr>
						<td>
					    ...
					    <td colspan="5"><!-- 
                          ...
                          <input class="button" type=submit value="确认" name=Submit2222>
                      【<a href="paddVersion?ptype=<s:property value="ptype"/>">添加</a>】<input name="ptype" type="hidden" value="<s:property value="ptype"/>"/></td>
				    </tr>
				</tbody>
				...
				<tbody>
					...
					<s:iterator value="versionManage" status="listid">
						<tr>
							...
							<td align="center" class="td1">
								<a href="pupdateVersion?issue=1&vid=<s:property value="id"/>&ptype=<s:property value="ptype"/>" >发布</a>|<a href="pupdateVersion?issue=0&vid=<s:property value="id"/>&ptype=<s:property value="ptype"/>">禁用</a>|<a href="pdeleteVersion?vid=<s:property value="id"/>&ptype=<s:property value="ptype"/>">删除</a> 							</td>
						</tr>
					</s:iterator>					
					<tr>
