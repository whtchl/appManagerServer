...
<table cellspacing="1" cellpadding="3" width="100%" align=left border="0">
    <tbody>
      <tr>
        <th colspan="7" class="td_title" style="TEXT-ALIGN: center"><a href="version">版 本 管 理</a>/<span class="STYLE1">OSM 版 本 管 理</span> </th>
      </tr>
	 
      <tr><td valign="top">[<a href="/customerService/saddVerInfo.jsp">新增版本</a>]<br></td>
    ...
    <tbody>
	 ...
	 <s:else>
      ...
      <tr>
        ...
        <td align="center" class='<s:property value="%{#cs}"/>'><a href="sgetVerInfo?vid=<s:property value="id"/>">修改</a></td>
      </tr>
      </s:iterator>
      <tr>
