...
<BODY>
<s:fielderror />
 <form name="theform" action="/addversionproduct" method="post"   onSubmit="return check();">
<table cellspacing=1 cellpadding=3 width="100%" align=center border=0>
 
    <tbody>
	 
      <tr>
        <th colspan=2 class="td_title" style="TEXT-ALIGN: center">添加应用软件  
		</th>
      </tr>
      <TR>
        <TD width="90" class=td2>应用名</TD>
        <TD width="640"class=td2>
          <div align="left"><INPUT size=25 name="productName"/><br>
              </div></TD></TR>
