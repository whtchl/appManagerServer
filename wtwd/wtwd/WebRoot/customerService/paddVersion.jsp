...
<HTML>
	...
	<BODY>
		<form action="psaveVersionInfo" method="post" enctype="multipart/form-data">
			<table cellspacing="1" cellpadding="3" width="937" align="center"
                ...
                <tr class='tdbg2'>
					...
					<td width='84%' class="td1">
					    <input  name="vname" type="text" /> <s:actionerror/><input  name="ptype" type="hidden" value="<s:property value="ptype"/>" />
					</td>
				</tr>
				<tr class='tdbg2'>
					<td width='16%' align='left' class="td1"> 
				...
				<tr class='tdbg2'>
					<td width='16%' align='left' class="td1"> 
						选择客户</td>
					<td width='84%' class="td1">
						<s:select list="companyList" listValue="name+'->'+code" listKey="code"   name="code" id="company" headerKey="" headerValue="全部"></s:select>
					</td>
				</tr>
