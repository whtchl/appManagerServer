...
<BODY>
<s:fielderror />
 <form name="theform" action="/updateVerInfo" method="post"   onSubmit="return check();">
<table cellspacing=1 cellpadding=3 width="100%" align=center border=0>
    ...
    <tbody>
      ...
      <TR>
        ...
        <TD class="td1"><label>
          <textarea name="versionbean.explain" cols="80" rows="5"><s:property value="versionbean.explain"/></textarea>
        </label>          &nbsp;<span class="STYLE1"></span></TD>
      </TR>
