				...
				<tbody>
					...
					<s:iterator value="roleList">
						<tr>
							...
							<td align=center class="td1">
								<a href="userList?userInfo.role.intId=<s:property value='intId'/>">共有(<s:property value="userCount"/>)个用户</a>
							</td>
							...
							<td align="center" class="td1">
								<a href="toUpdateRole?roleInfo.intId=<s:property value='intId'/>" title="修改角色">详情</a>
								&nbsp;&nbsp;|&nbsp;&nbsp;
		 ...
		 <script type="text/javascript">
      	function gotoo(id){
      		if(confirm("该角色下所有用户将会被一起删除，确定要删除吗？")){
	      		document.forms[0].action = "deleteRole?roleInfo.intId=" + id;
