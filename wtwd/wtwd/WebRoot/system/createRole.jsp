...
<HTML>
	...
	<BODY>
		<s:form action="saveRole" method="post">
			<table cellspacing="1" cellpadding="3" width="100%" align="center"
				border="0">
				<tr>
					<th colspan="3" class="td_title" style="TEXT-ALIGN: center">
						<span class="td_title" style="TEXT-ALIGN: center">创建新角色</span>
					</th>
				</tr>
				<tr class="tdbg">
				...
				<tr class="tdbg">
					...
					<td width='84%' class="td2">
						<span class="td1">
						<select name="roleInfo.mosId">
						<option value="0">请选择</option>
						<s:iterator value="roleList">
						<option value="<s:property value="intId"/>"><s:property value="name"/></option>
						</s:iterator>
						</select>
						</span>
					</td>
